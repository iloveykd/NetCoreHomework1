...
namespace homework1.Migrations
{
    ...
    [Migration("20200523022424_AddDepandPersonColumn")]
    partial class AddDepandPersonColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("homework1.Course", b =>
                {
            ...
            modelBuilder.Entity("homework1.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("homework1.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("homework1.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("homework1.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("homework1.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("homework1.Course", b =>
                {
                    b.HasOne("homework1.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("homework1.CourseInstructor", b =>
                {
                    b.HasOne("homework1.Course", "Course")
                    ...
                    b.HasOne("homework1.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("homework1.Enrollment", b =>
                {
                    ...
                    b.HasOne("homework1.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("homework1.OfficeAssignment", b =>
                {
                    b.HasOne("homework1.Person", "Instructor")
                        ...
                        .HasForeignKey("homework1.OfficeAssignment", "InstructorId")
